...
setDashboard(data);
  ...
  const uploadVerification = async () => {
    ...
    console.log(
      "🚀 UPLOAD VERIFICATION BUTTON CLICKED"
    );
  ...
  return (
    <>
      ...
      {newBooking && (
        <div className="fixed top-6 right-6 z-50 bg-green-600 text-white rounded-2xl shadow-2xl p-6 max-w-sm">
          ...
          <button
            ...
            className="mt-4 bg-white text-green-700 px-4 py-2 rounded-xl font-bold"
          >
            Close
          </button>
        </div>
      ...
      <div className="min-h-screen bg-gray-100 p-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-6 mt-8 mb-10">
